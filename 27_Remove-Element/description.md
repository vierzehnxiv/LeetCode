...
**Explanation:** Your function should return k = 5, with the first five elements of nums containing 0, 1, 4, 0, and 3 in any order. It does not matter what you leave beyond the returned k (hence they are underscores).
